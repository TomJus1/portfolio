...
p.nominalBounds = new cjs.Rectangle(0,0,393,600);
...
(lib.mainvyras_300x600 = function() {
	this.initialize(img.mainvyras_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,131,387);
...
p.nominalBounds = new cjs.Rectangle(0,0,8,96);


(lib.shadow_300x600 = function() {
	this.initialize(img.shadow_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,355,217);


(lib.zmogus2_300x600 = function() {
	this.initialize(img.zmogus2_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,135,356);// helper functions:
...
(lib.throwing = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.zmogus2_300x600();
	this.instance.setTransform(425,384);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.throwing, new cjs.Rectangle(425,384,135,356), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.mainvyras_300x600();
	this.instance.setTransform(481,-76);
...
p.nominalBounds = new cjs.Rectangle(481,-76,131,387);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.BG_300x600, null, new cjs.Matrix2D(1,0,0,1,-196.5,-300)).s().p("EgesAu4MAAAhdvMA9ZAAAMAAABdvg");
	this.shape.setTransform(103.5,300);
...
p.nominalBounds = new cjs.Rectangle(-93,0,393,600);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-128,-35);
...
p.nominalBounds = new cjs.Rectangle(-128,-35,35,35);
...
if (reversed == null) { reversed = false; }
	...
	// Throwing
	this.instance_7 = new lib.throwing("synched",0,false);
	this.instance_7.setTransform(-316.5,721,1,1,0,0,0,271.5,716);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:-169.5,y:557},23,cjs.Ease.cubicInOut).to({x:-179.5,y:567},205).wait(1));

	// Ball
	this.instance_8 = new lib.ball("synched",0);
	this.instance_8.setTransform(99,431.55,1,1,0,0,0,21,20);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:252,y:237},23,cjs.Ease.cubicInOut).to({x:262},205).wait(1));

	// Catching
	this.instance_9 = new lib.Catching("synched",0);
	this.instance_9.setTransform(29,685.5,1,1,0,0,0,173,115.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:-177.95,y:373.5},23,cjs.Ease.cubicInOut).to({x:-167.95},205).wait(1));

	// shadow
	this.instance_10 = new lib.shadow_300x600();
	this.instance_10.setTransform(-47,13);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(229));

	// BG
	this.instance_11 = new lib.BG("synched",0);
	this.instance_11.setTransform(206.5,300,1,1,0,0,0,206.5,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:226.5},228).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-13,300,515,581);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/mainvyras_300x600.png", id:"mainvyras_300x600"},
		...
		{src:"images/zmogus2_300x600.png", id:"zmogus2_300x600"}
	],
	preloads: []
};
