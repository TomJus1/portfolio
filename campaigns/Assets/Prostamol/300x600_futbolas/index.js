...
(lib.BG_300x600_futbolas = function() {
	this.initialize(img.BG_300x600_futbolas);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,413,600);
...
(lib.man_300x600 = function() {
	this.initialize(img.man_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,346,231);
...
p.nominalBounds = new cjs.Rectangle(0,0,8,96);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.BG_300x600_futbolas();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:38.05,y:318.5},23,cjs.Ease.cubicInOut).to({x:74},205).wait(1));

	// Ball
	this.instance_8 = new lib.ball("synched",0);
	this.instance_8.setTransform(342,205,1,1,0,0,0,21,20);
	...
	this.instance_9.setTransform(206.5,300,1,1,0,0,0,206.5,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:103.5},228).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-203,300,705,538);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/BG_300x600_futbolas.jpg", id:"BG_300x600_futbolas"},
		{src:"images/logo_300x600.png", id:"logo_300x600"},
		{src:"images/man_300x600.png", id:"man_300x600"},
