...
(lib.visual_300x250 = function() {
	this.initialize(img.visual_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,273,206);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.visual_300x250();
	this.instance.setTransform(93,-165);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Visual, new cjs.Rectangle(93,-165,273,206), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAAAzIgwBPIg5gqIA7hIIhcgaIAXhEIBWAmIgHhZIBHAAIgGBZIBXgmIAXBEIhdAYIA7BKIg6Aqg");
	this.shape.setTransform(184.225,27.875);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(156.075,38.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhzCmQgog5AAhsQAAhuAog5QAog5BLAAQBLAAApA5QAoA5AABuQAABsgoA5QgpA5hLABQhLgBgog5gAguhsQgQAmAABHQAABIAPAkQAQAlAfAAQAfAAAQglQAQgkABhIQAAhHgRgmQgRgkgegBQgeABgQAkg");
	this.shape_2.setTransform(125.85,38.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA2DaIhmjtIAADtIhWAAIAAmzIBSAAIBkDpIgBjpIBYAAIAAGzg");
	this.shape_3.setTransform(91.975,38.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgqDaIAAmzIBVAAIAAGzg");
	this.shape_4.setTransform(68.325,38.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABADaIgPhJIhgAAIgPBJIhZAAIBsmzIBXAAIBtGzgAAjBNIgjioIghCoIBEAAg");
	this.shape_5.setTransform(45.85,38.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAoDaIhUjbIAADbIhXAAIAAmzIBXAAIAADBIBOjBIBYAAIhWDJIBgDqg");
	this.shape_6.setTransform(18.1,38.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,202.4,77.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#597EB7").s().p("A18DZIAAmxMAr5AAAIAAGxg");
	this.shape.setTransform(140.475,26.825);
...
p.nominalBounds = new cjs.Rectangle(0,5.1,281,43.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AibDaIDgmzIBKAAIjgGzgAA9DZIBGhvQAPgZAHgPQAGgPAAgLQAAgJgDgFQgFgFgHAAQgHAAgEAFQgDAFAAALIAAASIhFAAIAAgSQAAgnAWgUQAWgWAmAAQAnAAAWATQAWATAAAgQABATgJAZQgJAZgTAhIgNAXIAuAAIAAA9gAjBAjIAAi8IghAAIARg/IBaAAIAAD7g");
	this.shape.setTransform(240.55,38.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiLERICXlfIiEAAIAAhTIEEAAIibFhICOAAIAABRgAghjAIhChQIBIAAIAbAdIAcgdIBIAAIhDBQg");
	this.shape_1.setTransform(190.775,33.125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhgC6QgjgiAAg+IAAk2IBWAAIAAExQAAAeALAOQALAOAXgBQAXABAMgOQALgOAAgeIAAkxIBWAAIAAE2QAAA+gjAiQgiAig/ABQg+gBgigig");
	this.shape_2.setTransform(160.175,39.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgqDaIAAmzIBVAAIAAGzg");
	this.shape_3.setTransform(125.225,38.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAmDaIhNiyIgEAAIAACyIhWAAIAAmzIBpAAQBDABAjAgQAjAgAAA/QAAAsgRAeQgSAcgiAPIBWC+gAgrghIATAAQAZAAANgOQAMgOAAgdQAAgcgMgOQgNgOgZgBIgTAAg");
	this.shape_4.setTransform(104.55,38.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgrDaIAAlhIhHAAIAAhSIDlAAIAABSIhIAAIAAFhg");
	this.shape_5.setTransform(77,38.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA2DaIhmjtIAADtIhWAAIAAmzIBSAAIBkDpIgBjpIBYAAIAAGzg");
	this.shape_6.setTransform(48.925,38.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABADaIgPhJIhgAAIgQBJIhZAAIBtmzIBXAAIBsGzgAAjBNIgjioIghCoIBEAAg");
	this.shape_7.setTransform(17.25,38.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,279.2,77.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:94.95},17,cjs.Ease.cubicInOut).wait(38).to({startPosition:0},0).to({scaleX:1.1142,scaleY:1.1142,x:131.35},8,cjs.Ease.cubicInOut).to({scaleX:1,scaleY:1,x:131.3},13,cjs.Ease.bounceOut).wait(17).to({startPosition:0},0).to({scaleX:1.1142,scaleY:1.1142,x:131.35},8,cjs.Ease.cubicInOut).to({scaleX:1,scaleY:1,x:131.3},13,cjs.Ease.bounceOut).wait(55).to({startPosition:0},0).wait(1).to({regX:101.5,regY:38,x:101.5,y:93.05},0).wait(1).to({y:90.4},0).wait(1).to({y:85.9},0).wait(1).to({y:78.95},0).wait(1).to({y:68.35},0).wait(1).to({y:52.35},0).wait(1).to({y:29.1},0).wait(1).to({y:1.55},0).wait(1).to({y:-21.25},0).wait(1).to({y:-36.5},0).wait(1).to({y:-46.3},0).wait(1).to({y:-52.5},0).wait(1).to({regX:131.3,regY:38.6,x:131.3,y:-55.6},0).to({_off:true},1).wait(107));
...
p.nominalBounds = new cjs.Rectangle(-14.9,-152,316.2,290.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(158.65,12.9,0.8058,0.8058,0,0,0,6.1,7.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(25));

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AXcjAIAAGBMgu3AAAIAAmB");
	this.shape.setTransform(150,19.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A3bDBIAAmBMAu3AAAIAAGBg");
	this.shape_1.setTransform(150,19.3);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,302,40.6);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A18HjIAAmzMAr5AAAIAAGzg");
	var mask_graphics_1 = new cjs.Graphics().p("A18HgIAAmyMAr5AAAIAAGyg");
	var mask_graphics_2 = new cjs.Graphics().p("A18HZIAAmzMAr5AAAIAAGzg");
	var mask_graphics_3 = new cjs.Graphics().p("A18HNIAAmzMAr5AAAIAAGzg");
	var mask_graphics_4 = new cjs.Graphics().p("A18G8IAAmzMAr5AAAIAAGzg");
	var mask_graphics_5 = new cjs.Graphics().p("A18GmIAAmyMAr5AAAIAAGyg");
	var mask_graphics_6 = new cjs.Graphics().p("A18GLIAAmyMAr5AAAIAAGyg");
	var mask_graphics_7 = new cjs.Graphics().p("A18FrIAAmyMAr5AAAIAAGyg");
	var mask_graphics_8 = new cjs.Graphics().p("A18FLIAAmxMAr5AAAIAAGxg");
	var mask_graphics_9 = new cjs.Graphics().p("A18EwIAAmxMAr5AAAIAAGxg");
	var mask_graphics_10 = new cjs.Graphics().p("A18EaIAAmxMAr5AAAIAAGxg");
	var mask_graphics_11 = new cjs.Graphics().p("A18EJIAAmyMAr5AAAIAAGyg");
	var mask_graphics_12 = new cjs.Graphics().p("A18D8IAAmxMAr5AAAIAAGxg");
	var mask_graphics_13 = new cjs.Graphics().p("A18D1IAAmxMAr5AAAIAAGxg");
	var mask_graphics_14 = new cjs.Graphics().p("A18DZIAAmxMAr5AAAIAAGxg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:140.475,y:48.275}).wait(1).to({graphics:mask_graphics_1,x:140.475,y:48.025}).wait(1).to({graphics:mask_graphics_2,x:140.475,y:47.3}).wait(1).to({graphics:mask_graphics_3,x:140.475,y:46.075}).wait(1).to({graphics:mask_graphics_4,x:140.475,y:44.35}).wait(1).to({graphics:mask_graphics_5,x:140.475,y:42.15}).wait(1).to({graphics:mask_graphics_6,x:140.475,y:39.45}).wait(1).to({graphics:mask_graphics_7,x:140.475,y:36.275}).wait(1).to({graphics:mask_graphics_8,x:140.475,y:33.1}).wait(1).to({graphics:mask_graphics_9,x:140.475,y:30.4}).wait(1).to({graphics:mask_graphics_10,x:140.475,y:28.2}).wait(1).to({graphics:mask_graphics_11,x:140.475,y:26.475}).wait(1).to({graphics:mask_graphics_12,x:140.475,y:25.25}).wait(1).to({graphics:mask_graphics_13,x:140.475,y:24.525}).wait(1).to({graphics:mask_graphics_14,x:140.475,y:26.825}).wait(11));
...
p.nominalBounds = new cjs.Rectangle(0,5.1,281,91.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(150,236.25,1,1,0,0,0,150,25);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(183));

	// Blue
	this.instance_1 = new lib.Disclaimer("synched",0,false);
	this.instance_1.setTransform(18.65,187.05,0.863,0.863,0,0,0,24.4,13);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},0).wait(149).to({startPosition:24},0).to({y:220.05},14,cjs.Ease.cubicInOut).wait(1));

	// Visual
	this.instance_2 = new lib.Visual();
	this.instance_2.setTransform(152,538.5,0.9676,0.9676,0,0,0,185,167.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:373.5},19,cjs.Ease.quadInOut).to({scaleX:1,scaleY:1,y:382.5},148,cjs.Ease.quadInOut).to({y:550.45},15,cjs.Ease.quadInOut).wait(1));

	// Text
	this.instance_3 = new lib.Text("synched",0,false);
	this.instance_3.setTransform(20.55,15.15,0.5959,0.5959,0,0,0,11.7,16.6);
...
p.nominalBounds = new cjs.Rectangle(147.6,39.7,185.4,384.3);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/visual_300x250.png", id:"visual_300x250"}
	],
	preloads: []
};
