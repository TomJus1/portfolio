...
(lib.Aktoriai_300x250 = function() {
	this.initialize(img.Aktoriai_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,197,227);


(lib.BG_300x250_1 = function() {
	this.initialize(img.BG_300x250_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,353,250);


(lib.BG_300x250_2 = function() {
	this.initialize(img.BG_300x250_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,372,254);


(lib.gnt_300x250 = function() {
	this.initialize(img.gnt_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,122,72);


(lib.Manobilietaslogo2white_300x250 = function() {
	this.initialize(img.Manobilietaslogo2white_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,90,12);


(lib.pavadinimas_300x250 = function() {
	this.initialize(img.pavadinimas_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,99,51);


(lib.val_300x250 = function() {
	this.initialize(img.val_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,145,19);


(lib.Vardai_300x250 = function() {
	this.initialize(img.Vardai_300x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,107,29);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Aktoriai_300x250();
...
p.nominalBounds = new cjs.Rectangle(151,-150,197,227);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AwPyDIAAkiMAgfAAAIAAEig");
	mask.setTransform(60.5,-144.65);

	// Layer_1
	this.instance = new lib.Vardai_300x250();
	this.instance.setTransform(-3,-304);
...
p.nominalBounds = new cjs.Rectangle(-3,-289.3,107,14.300000000000011);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(35.3,-303.5);

	// Layer_1
	this.instance = new lib.Vardai_300x250();
	this.instance.setTransform(-18,-304);
...
p.nominalBounds = new cjs.Rectangle(-18,-304,107,15);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.val_300x250();
...
p.nominalBounds = new cjs.Rectangle(-4,-40,145,19);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AFDDVIgrgcIAAgyIhKAAIgigWIlWAAIgmAWIhAAAIAAAlIhFApIleAAIAAmpIVnAAIAAGpg");
	mask.setTransform(29.5,37.425);

	// Layer_1
	this.instance = new lib.gnt_300x250();
...
p.nominalBounds = new cjs.Rectangle(-33,16.2,122,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(273.5,-70);
...
p.nominalBounds = new cjs.Rectangle(0,-211,547,282);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AkEBkIAAjHIIJAAIAADHg");
	mask.setTransform(21.05,58.95);

	// Layer_1
	this.instance = new lib.gnt_300x250();
	this.instance.setTransform(-40,-7);
...
p.nominalBounds = new cjs.Rectangle(-5,49,52.2,16);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(20.925,2.675);
...
p.nominalBounds = new cjs.Rectangle(-40,-4,122,23.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.BG_300x250_2();
...
p.nominalBounds = new cjs.Rectangle(38,-1,372,254);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.BG_300x250_1();
...
p.nominalBounds = new cjs.Rectangle(5,0,353,250);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pavadinimas_300x250();
	this.instance.setTransform(-19,1);
...
p.nominalBounds = new cjs.Rectangle(-19,1,99,51);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-32.45,21.35,0.5661,0.5661,0,0,0,8.8,10.2);
...
p.nominalBounds = new cjs.Rectangle(-37.4,15.6,50.9,20.799999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(103.05,17.85,1.3862,1.3862,0,0,0,77.5,18.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1,scaleY:1,x:77.5,y:15.1,alpha:1},17,cjs.Ease.backOut).wait(20));

	// Layer_5
	this.instance_1 = new lib.tragedijos("synched",0);
	this.instance_1.setTransform(91.35,59.15,1.2689,1.2689,0,0,0,85,52.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({scaleX:1,scaleY:1,x:78.4,y:52.1,alpha:1},17,cjs.Ease.backOut).wait(17));
...
p.nominalBounds = new cjs.Rectangle(-59.8,-13.3,169.1,80.89999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(149.65,162.1,1.3715,1.3715,0,0,0,126.5,16.6);
	...
	this.instance_4.setTransform(149.55,85.5,1.4667,1.4667,0,0,0,87,45.1);
...
p.nominalBounds = new cjs.Rectangle(-29.3,15.6,198.9,158.70000000000002);
...
if (reversed == null) { reversed = false; }
	...
	// manoBilietas_lt
	this.instance = new lib.Manobilietaslogo2white_300x250();
	this.instance.setTransform(178,206);
	...
	this.CTA.name = "CTA";
	this.CTA.setTransform(92.3,202.85,0.8079,0.8079,0,0,0,66.8,18.1);

	this.timeline.addTween(cjs.Tween.get(this.CTA).wait(42).to({regX:66.9,regY:18.2,scaleX:0.9359,scaleY:0.9359,x:92.4,y:202.95},6).to({regX:66.8,regY:18.1,scaleX:0.8079,scaleY:0.8079,x:92.3,y:202.85},11,cjs.Ease.bounceOut).wait(89).to({regX:66.9,regY:18.2,scaleX:0.9359,scaleY:0.9359,x:92.4,y:202.95},6).to({regX:66.8,regY:18.1,scaleX:0.8079,scaleY:0.8079,x:92.3,y:202.85},11,cjs.Ease.bounceOut).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(98).to({_off:false},0).wait(93).to({startPosition:36},0).to({x:-212},14,cjs.Ease.cubicInOut).wait(1));

	// Text1
	this.instance_2 = new lib.Text1("synched",0,false);
	this.instance_2.setTransform(151.5,247.4,1,1,0,0,0,126.5,239.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(87).to({startPosition:57},0).to({x:-228.5},15,cjs.Ease.cubicInOut).to({_off:true},1).wait(103));

	// shadow
	this.instance_3 = new lib.Shadow("synched",0);
	this.instance_3.setTransform(154.5,615,1,1,0,0,0,273.5,141);
	this.instance_3._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90).to({_off:false},0).to({x:155},15,cjs.Ease.cubicInOut).wait(86).to({startPosition:0},0).to({x:-195},14,cjs.Ease.cubicInOut).wait(1));

	// BG1
	this.instance_5 = new lib.BG_1("synched",0);
	this.instance_5.setTransform(483,300,1,1,0,0,0,178,300);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(191).to({_off:false},0).to({x:168},14,cjs.Ease.cubicInOut).wait(1));

	// BG2
	this.instance_6 = new lib.BG2("synched",0);
	this.instance_6.setTransform(514,300,1,1,0,0,0,230,300);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(87).to({_off:false},0).to({x:158},15,cjs.Ease.cubicInOut).to({x:138},89).to({x:-180},14,cjs.Ease.cubicInOut).wait(1));

	// BG1
	this.instance_7 = new lib.BG_1("synched",0);
	this.instance_7.setTransform(168,300,1,1,0,0,0,178,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:148},87).to({x:-212},15,cjs.Ease.cubicInOut).to({_off:true},1).wait(103));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-399,124,1093,421);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Aktoriai_300x250.png", id:"Aktoriai_300x250"},
		{src:"images/BG_300x250_1.jpg", id:"BG_300x250_1"},
		{src:"images/BG_300x250_2.jpg", id:"BG_300x250_2"},
		{src:"images/gnt_300x250.png", id:"gnt_300x250"},
		{src:"images/Manobilietaslogo2white_300x250.png", id:"Manobilietaslogo2white_300x250"},
		{src:"images/pavadinimas_300x250.png", id:"pavadinimas_300x250"},
		{src:"images/val_300x250.png", id:"val_300x250"},
		{src:"images/Vardai_300x250.png", id:"Vardai_300x250"}
	],
	preloads: []
};
