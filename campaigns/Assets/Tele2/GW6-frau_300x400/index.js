...
}).prototype = getMCSymbolPrototype(lib.Watch, new cjs.Rectangle(0,0,300,400), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(49.6229,99.7085,0.25,0.25,90);
...
p.nominalBounds = new cjs.Rectangle(0,0,99.7,108.4);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("ADOKGIAAg4IA4AAIAAA4g");
	var mask_graphics_1 = new cjs.Graphics().p("AARJ7IAAk2IE1AAIAAE2g");
	var mask_graphics_2 = new cjs.Graphics().p("AiMJxIAAoHIIHAAIAAIHg");
	var mask_graphics_3 = new cjs.Graphics().p("AkLJqIAAqxIKxAAIAAKxg");
	var mask_graphics_4 = new cjs.Graphics().p("AlwJkIAAs3IM4AAIAAM3g");
	var mask_graphics_5 = new cjs.Graphics().p("Am8JgIAAueIOeAAIAAOeg");
	var mask_graphics_6 = new cjs.Graphics().p("An0JcIAAvoIPpAAIAAPog");
	var mask_graphics_7 = new cjs.Graphics().p("AoMJaIAAwZIQZAAIAAQZg");
	var mask_graphics_8 = new cjs.Graphics().p("AobJZIAAw2IQ3AAIAAQ2g");
	var mask_graphics_9 = new cjs.Graphics().p("AogJYIAAxBIRBAAIAARBg");
	var mask_graphics_10 = new cjs.Graphics().p("AofJYIAAw+IQ/AAIAAQ+g");
	var mask_graphics_11 = new cjs.Graphics().p("AoZJZIAAwyIQzAAIAAQyg");
	var mask_graphics_12 = new cjs.Graphics().p("AoQJaIAAwgIQhAAIAAQgg");
	var mask_graphics_13 = new cjs.Graphics().p("AoFJbIAAwLIQLAAIAAQLg");
	var mask_graphics_14 = new cjs.Graphics().p("An8JcIAAv4IP5AAIAAP4g");
	var mask_graphics_15 = new cjs.Graphics().p("An0JcIAAvpIPpAAIAAPpg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:26.1832,y:64.5568}).wait(1).to({graphics:mask_graphics_1,x:32.6125,y:63.4548}).wait(1).to({graphics:mask_graphics_2,x:37.9005,y:62.5374}).wait(1).to({graphics:mask_graphics_3,x:42.2334,y:61.7911}).wait(1).to({graphics:mask_graphics_4,x:45.6198,y:61.1991}).wait(1).to({graphics:mask_graphics_5,x:48.2231,y:60.7498}).wait(1).to({graphics:mask_graphics_6,x:50.104,y:60.4288}).wait(1).to({graphics:mask_graphics_7,x:50.248,y:60.1967}).wait(1).to({graphics:mask_graphics_8,x:50.2174,y:60.0903}).wait(1).to({graphics:mask_graphics_9,x:50.2227,y:60.0203}).wait(1).to({graphics:mask_graphics_10,x:50.1995,y:60.0472}).wait(1).to({graphics:mask_graphics_11,x:50.2356,y:60.0836}).wait(1).to({graphics:mask_graphics_12,x:50.2145,y:60.1629}).wait(1).to({graphics:mask_graphics_13,x:50.1739,y:60.2729}).wait(1).to({graphics:mask_graphics_14,x:50.201,y:60.3755}).wait(1).to({graphics:mask_graphics_15,x:50.1307,y:60.4055}).wait(1).to({graphics:mask_graphics_16,x:49.85,y:60.35}).wait(178).to({graphics:mask_graphics_194,x:49.85,y:60.35}).wait(1).to({graphics:null,x:0,y:0}).wait(20));
	...
	this.instance_3.setTransform(49.55,129.6,0.0558,0.0558,0,0,0,49.2,108.4);
...
p.nominalBounds = new cjs.Rectangle(-4.3,-2.4,109.1,132);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(47.65,363.7,1,1,0,0,0,-32.3,-4.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(207));

	// text
	this.instance = new lib.text("synched",0);
	this.instance.setTransform(152.45,38.05,1.1756,1.1756,0,0,0,125.5,20.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1,scaleY:1,x:152.4,alpha:1},14,cjs.Ease.backOut).wait(35).to({startPosition:0},0).to({regY:20.7,scaleX:1.1106,scaleY:1.1106,x:152.5,y:38.2},6,cjs.Ease.quadInOut).to({regY:20.6,scaleX:1,scaleY:1,x:152.4,y:38.05},12,cjs.Ease.bounceOut).wait(47).to({startPosition:0},0).to({regY:20.7,scaleX:1.1106,scaleY:1.1106,x:152.5,y:38.2},6,cjs.Ease.quadInOut).to({regY:20.6,scaleX:1,scaleY:1,x:152.4,y:38.05},12,cjs.Ease.bounceOut).wait(75));

	// price
	this.instance_1 = new lib.Price("synched",0,false);
	this.instance_1.setTransform(77.8,130.65,1,1,0,0,0,49.9,65);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(12).to({_off:false},0).wait(195));

	// Watch
	this.instance_2 = new lib.Watch();
	this.instance_2.setTransform(-59.35,270.25,0.5534,0.5534,0,0,0,150.1,200.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(5).to({_off:false},0).to({x:80.05,y:267.15},14,cjs.Ease.cubicInOut).wait(188));

	// moteris
	this.instance_3 = new lib.moteris();
	this.instance_3.setTransform(384.5,242.05,0.8709,0.8709,0,0,0,82.5,196);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({_off:false},0).to({x:220.5},14,cjs.Ease.cubicInOut).wait(174));

	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF3F3F").s().p("EggBAm1MAAAhNpMBADAAAMAAABNpg");
	this.shape_1.setTransform(150,204.525);
...
p.nominalBounds = new cjs.Rectangle(7.6,156.1,438.59999999999997,296.9);
// library properties:
lib.properties = {
