...
(lib.Image1_300x600 = function() {
	this.initialize(img.Image1_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,354,600);


(lib.Image2_300x600 = function() {
	this.initialize(img.Image2_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,354,600);


(lib.Image3_300x600 = function() {
	this.initialize(img.Image3_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,354,600);


(lib.Image4_300x600 = function() {
	this.initialize(img.Image4_300x600);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,354,600);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgYA+QgKgGgFgMQgGgMgBgQQABgQAFgLQAGgMAJgGQAJgGANAAQAIAAAGADQAGADADAEIAFAIIABAAIgBgyIAUAAIACCFIgUAAIAAgPIgCAAIgEAHQgEAEgFADQgHADgIAAQgMAAgJgGgAgOgOQgGAFgDAIQgDAHAAAKQABAKADAIQADAIAGAFQAFAEAIAAQAJAAAGgEQAFgFADgIQADgHAAgLQAAgQgGgJQgIgJgMAAQgIAAgGAEg");
	this.shape.setTransform(53,13.325);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAXAzIgBg9QABgLgHgGQgFgGgKAAQgKAAgFAHQgIAGAAAMIABA7IgUAAIAAhkIASAAIABARIABAAQAEgIAGgFQAIgFAKAAQALAAAHAEQAIAFAFAIQAEAJAAAMIAAA/g");
	this.shape_1.setTransform(41.95,14.825);
	...
	this.shape_2.setTransform(30.975,14.925);
	...
	this.shape_3.setTransform(20.025,16.725);
	...
	this.shape_4.setTransform(8.175,13.25);
...
p.nominalBounds = new cjs.Rectangle(-2.3,0,186.5,26.4);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(122.925,14.925);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgIBDIgBiFIASAAIABCFg");
	this.shape_1.setTransform(115.15,13.225);
	...
	this.shape_2.setTransform(107,16.825);
	...
	this.shape_3.setTransform(95.95,14.925);
	...
	this.shape_4.setTransform(84.85,14.925);
	...
	this.shape_5.setTransform(72.3234,13.225);
	...
	this.shape_6.setTransform(55,14.825);
	...
	this.shape_7.setTransform(43.95,14.925);
	...
	this.shape_8.setTransform(28.025,14.925);
	...
	this.shape_9.setTransform(17.125,14.925);
	...
	this.shape_10.setTransform(6.775,14.925);
...
p.nominalBounds = new cjs.Rectangle(-2.8,0,186.60000000000002,26.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AghBFIgFgCIAFgQQAIADAFgDQAFgCAEgKIACgGIglhlIAUAAIAaBNIAAAAIAZhNIAWAAIgoBxQgFAMgHAGQgIAGgMAAIgIAAg");
	this.shape.setTransform(109.425,39.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgIBDIgBiFIATAAIABCFg");
	this.shape_1.setTransform(101.9,36.275);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgIBDIgCiFIAUAAIABCFg");
	this.shape_2.setTransform(97.3,36.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(89.55,38);
	...
	this.shape_4.setTransform(78.975,38.025);
	...
	this.shape_5.setTransform(68.575,37.975);
	...
	this.shape_6.setTransform(58.075,38.025);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgIBDIgCiFIATAAIACCFg");
	this.shape_7.setTransform(45.35,36.275);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgIBDIgCiFIATAAIABCFg");
	this.shape_8.setTransform(40.75,36.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgHAYIgBgvIAQAAIABAvg");
	this.shape_9.setTransform(36.4,31.95);
	...
	this.shape_10.setTransform(28.975,38.025);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgYAuQgKgHgGgMQgGgMAAgPQAAgPAFgMQAGgLAKgHQALgGAOAAQANAAALAHQALAGAFAMQAHAMAAAPQAAAQgGALQgFAMgKAGQgLAGgOAAQgNAAgMgGgAgPgdQgFAFgEAIQgDAIABAJQAAAKACAHQADAIAGAFQAHAFAIAAQAJAAAGgFQAGgFAEgIQACgJAAgJQAAgJgDgIQgDgIgFgFQgGgEgJgBQgJABgHAFg");
	this.shape_11.setTransform(17.95,37.975);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AghBFIgFgCIAFgQQAIADAFgDQAFgCAEgKIACgGIglhlIAUAAIAaBNIAAAAIAZhNIAWAAIgoBxQgFAMgHAGQgIAGgMAAIgIAAg");
	this.shape_12.setTransform(7.075,39.85);
	...
	this.shape_13.setTransform(137.275,14.925);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AABA8QgGgDgEgGQgDgGAAgJIgCg6IgOAAIAAgQIAPAAIgBgYIATAAIABAYIAUAAIAAAQIgUAAIAAA2QAAAIAEADQADADAFAAIAEgBIADAAIAEAQIgFABIgIABQgIAAgHgDg");
	this.shape_14.setTransform(128.3,13.775);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(119.45,14.95);
	...
	this.shape_16.setTransform(111.2,14.825);
	...
	this.shape_17.setTransform(96.875,14.925);
	...
	this.shape_18.setTransform(85.875,13.225);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AABA8QgFgDgEgGQgFgGAAgJIgBg6IgOAAIAAgQIAPAAIgBgYIATAAIAAAYIAVAAIAAAQIgVAAIABA2QAAAIAEADQADADAFAAIAEgBIADAAIAEAQIgFABIgIABQgIAAgHgDg");
	this.shape_19.setTransform(76.8,13.775);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AABA8QgFgDgEgGQgFgGAAgJIgBg6IgOAAIAAgQIAPAAIgBgYIATAAIAAAYIAVAAIAAAQIgVAAIABA2QABAIADADQADADAFAAIAEgBIADAAIAEAQIgFABIgJABQgGAAgIgDg");
	this.shape_20.setTransform(65,13.775);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("");
	this.shape_21.setTransform(56.15,14.95);
...
p.nominalBounds = new cjs.Rectangle(-2.7,0,235.79999999999998,49.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Image4_300x600();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Image3_300x600();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Image2_300x600();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Image1_300x600();
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgWAuQgLgHgGgLQgGgMAAgQQAAgOAGgMQAFgMALgGQAKgHANAAQAMAAAKAFQAKAFAHALQAGAMABASIgBAGIhGAAQAAAQAIAHQAHAHANAAQAIAAAGgEQAGgDADgHIASADQgDANgLAHQgKAHgRAAQgOAAgLgGgAAagIQAAgMgHgHQgHgIgLAAQgHAAgGAEQgGAEgDAGQgEAGgBAHIA0AAIAAAAg");
	this.shape.setTransform(108.125,-8.325);
	...
	this.shape_1.setTransform(97.125,-10.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AABA8QgFgDgEgGQgFgGAAgJIgBg6IgOAAIAAgQIAPAAIgBgYIATAAIAAAYIAVAAIAAAQIgVAAIABA2QAAAIAEADQADADAFAAIAEgBIADAAIAEAQIgFABIgIABQgIAAgHgDg");
	this.shape_2.setTransform(88.05,-9.475);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAXAzIAAg9QAAgLgHgGQgFgGgKAAQgKAAgFAHQgIAGAAAMIABA7IgTAAIgBhkIATAAIAAARIABAAQAEgIAGgFQAIgFAKAAQALAAAHAEQAIAFAFAIQAEAJAAAMIAAA/g");
	this.shape_3.setTransform(74.25,-8.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgIBGIgBhkIATAAIABBkgAgHgxQgEgDgBgFQAAgGADgCQADgEAFAAQAFAAADAEQAFACAAAGQABAFgDADQgEADgFABQgEgBgEgDg");
	this.shape_4.setTransform(66.3536,-10.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("A


	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgWAuQgLgHgGgLQgGgMAAgQQAAgOAGgMQAFgMALgGQAKgHANAAQAMAAAKAFQAKAFAHALQAGAMABASIgBAGIhGAAQAAAQAIAHQAHAHANAAQAIAAAGgEQAGgDADgHIASADQgDANgLAHQgKAHgRAAQgOAAgLgGgAAagIQAAgMgHgHQgHgIgLAAQgHAAgGAEQgGAEgDAGQgEAGgBAHIA0AAIAAAAg");
	this.shape_15.setTransform(43.475,14.925);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgZAzIgBhkIATAAIAAAQIABAAQADgIAGgEQAGgFAKAAIAEAAIAEAAIAAATIgEgBIgGAAQgLAAgGAGQgGAHAAAKIABA8g");
	this.shape_16.setTransform(34.85,14.825);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgZAzIgBhkIATAAIAAAQIABAAQADgIAGgEQAHgFAIAAIAFAAIAEAAIAAATIgEgBIgGAAQgKAAgHAGQgGAHAAAKIABA8g");
	this.shape_17.setTransform(27.7,14.825);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgZAvQgHgFgEgIQgEgIgBgNIAAg/IAUAAIAAA9QAAAKAGAGQAFAGAKAAQAEAAAGgDQAFgCADgGQAEgFAAgJIAAg6IATAAIABBkIgTAAIAAgSIgBAAQgEAJgHAFQgIAFgLAAQgJAAgIgEg");
	this.shape_18.setTransform(18.225,14.975);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgVAuQgLgHgFgMQgGgLAAgQQgBgOAGgMQAGgMAKgGQALgHANAAQARAAAMAJQALAJACAQIgTAAQgCgHgFgFQgGgFgKAAQgLAAgIAJQgGAJgBAQQABAQAHAKQAIAKALAAQAJAAAFgFQAGgEACgJIATAAQgBAKgFAIQgFAHgJAFQgJAEgMAAQgNAAgLgGg");
	this.shape_19.setTransform(7.5231,14.925);
...
p.nominalBounds = new cjs.Rectangle(-4.7,-23.2,188.89999999999998,72.8);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(74).to({_off:false},0).to({alpha:1},26).wait(58).to({startPosition:0},0).to({_off:true},1).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50).to({_off:false},0).to({alpha:1},24,cjs.Ease.cubicInOut).wait(84).to({startPosition:0},0).to({_off:true},1).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(18).to({_off:false},0).to({alpha:1},32).wait(108).to({startPosition:0},0).to({_off:true},1).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:1},25).wait(133).to({startPosition:0},0).to({_off:true},1).wait(147));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4.7,-0.1,237.79999999999998,119.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(37).to({_off:false},0).to({alpha:1},28).wait(82).to({startPosition:0},0).to({alpha:0},25,cjs.Ease.cubicInOut).wait(137));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(32).to({_off:false},0).to({alpha:1},28).wait(83).to({startPosition:0},0).to({alpha:0},25,cjs.Ease.cubicInOut).wait(141));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},28).wait(111).to({startPosition:0},0).to({alpha:0},25,cjs.Ease.cubicInOut).wait(145));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-196.2,300,1,1,0,0,0,177,300);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(232).to({_off:false},0).to({x:143.1},20,cjs.Ease.cubicInOut).wait(79).to({startPosition:0},0).to({_off:true},1).wait(2));

	// image3
	this.instance_1 = new lib.image3("synched",0);
	this.instance_1.setTransform(480.35,300,1,1,0,0,0,177,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(151).to({_off:false},0).to({x:157.8},20,cjs.Ease.cubicInOut).wait(61).to({startPosition:0},0).to({x:497.1},20,cjs.Ease.cubicInOut).to({_off:true},1).wait(81));

	// image2
	this.instance_2 = new lib.image2("synched",0);
	this.instance_2.setTransform(-179.15,300,1,1,0,0,0,177,300);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(70).to({_off:false},0).to({x:126.35},20,cjs.Ease.cubicInOut).wait(61).to({startPosition:0},0).to({x:-196.2},20,cjs.Ease.cubicInOut).to({_off:true},1).wait(162));

	// image1
	this.instance_3 = new lib.image1("synched",0);
	this.instance_3.setTransform(174.85,300,1,1,0,0,0,177,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(70).to({startPosition:0},0).to({x:480.35},20,cjs.Ease.cubicInOut).to({_off:true},1).wait(243));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-373.2,0,1047.3,600);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(17.9,21.35,0.3804,0.3804,0,0,0,6.7,1.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(334));

	// BG
	this.instance_1 = new lib.BG("single",0);
	this.instance_1.setTransform(499.25,300,1,1,0,0,0,177,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(313).to({_off:false},0).to({x:177},20,cjs.Ease.cubicInOut).wait(1));

	// CTA
	this.CTA = new lib.CTA();
	this.CTA.name = "CTA";
	this.CTA.setTransform(150.15,558.15,1.4527,1.4527,0,0,0,84,20.8);
	this.CTA.alpha = 0;
	this.CTA._off = true;

	this.timeline.addTween(cjs.Tween.get(this.CTA).wait(50).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},17,cjs.Ease.cubicInOut).wait(37).to({regX:84.1,regY:20.9,scaleX:1.119,scaleY:1.119,x:150.25,y:558.3},9,cjs.Ease.quadInOut).to({regX:84,regY:20.8,scaleX:1,scaleY:1,x:150.15,y:558.15},15,cjs.Ease.bounceOut).wait(124).to({regX:84.1,regY:20.9,scaleX:1.119,scaleY:1.119,x:150.25,y:558.3},9,cjs.Ease.quadInOut).to({regX:84,regY:20.8,scaleX:1,scaleY:1,x:150.15,y:558.15},15,cjs.Ease.bounceOut).wait(37).to({x:-179.85},20,cjs.Ease.cubicInOut).wait(1));

	// Text2
	this.instance_2 = new lib.Text2("synched",0);
	this.instance_2.setTransform(104,131.05,1,1,0,0,0,91,59.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(154).to({_off:false},0).wait(159).to({startPosition:125},0).to({x:-226,startPosition:145},20,cjs.Ease.cubicInOut).wait(1));

	// Text1
	this.instance_3 = new lib.Text1("synched",0,false);
	this.instance_3.setTransform(134.05,128,1,1,0,0,0,120.5,64.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(313).to({startPosition:279},0).to({x:-195.95,startPosition:299},20,cjs.Ease.cubicInOut).wait(1));

	// Card
	this.instance_4 = new lib.Card_BG("synched",0,false);
	this.instance_4.setTransform(149.65,335.15,0.3659,0.3659,0,0,0,308.9,194.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:194.7,scaleX:0.4112,scaleY:0.4112,x:149.7,startPosition:72},72,cjs.Ease.quadInOut).to({regY:194.6,scaleX:0.3659,scaleY:0.3659,x:149.65,startPosition:92},20,cjs.Ease.backOut).wait(221).to({startPosition:279},0).to({x:-180.35,startPosition:299},20,cjs.Ease.cubicInOut).wait(1));

	// BG
	this.instance_5 = new lib.BG("synched",0,false);
	this.instance_5.setTransform(177,300,1,1,0,0,0,177,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(313).to({startPosition:312},0).to({x:-145.25},20,cjs.Ease.cubicInOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-223.2,300,897.3,300);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Image1_300x600.jpg", id:"Image1_300x600"},
		{src:"images/Image2_300x600.jpg", id:"Image2_300x600"},
		{src:"images/Image3_300x600.jpg", id:"Image3_300x600"},
		{src:"images/Image4_300x600.jpg", id:"Image4_300x600"}
	],
	preloads: []
};
